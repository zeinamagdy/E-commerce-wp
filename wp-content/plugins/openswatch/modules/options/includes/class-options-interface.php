...
class OpenWatch_Options_Framework_Interface {
	...
	static function optionsframework_fields() {
        ...
        $option_name = 'optionsframework_vna';
		...
		foreach ( $options as $value ) {
			...
			// Uploader
			case "upload":
				$output .= OpenWatch_Options_Framework_Media_Uploader::optionsframework_uploader( $value['id'], $val, null );
			...
			case 'background':
				...
				$output .= OpenWatch_Options_Framework_Media_Uploader::optionsframework_uploader( $value['id'], $background['image'], null, esc_attr( $option_name . '[' . $value['id'] . '][image]' ) );
		...
		if ( OpenWatch_Options_Framework_Interface::optionsframework_tabs() != '' ) {
			echo '</div>';
		}
	}
