...
class OpenWatch_Options_Framework {
	...
	function set_theme_option() {
        ...
        if ( function_exists( 'openwatch_optionsframework_option_name' ) ) {
            openwatch_optionsframework_option_name();
        }
        ...
        // If the developer hasn't explicitly set an option id, we'll use a default
            ...
            $default_themename = 'optionsframework_vna';
	...
	static function &_optionsframework_options() {
		...
		if ( !$options ) {
            ...
            $optionsfile = OPENSWATCH_PATH.'modules/options/options.php';
            $maybe_options = require_once $optionsfile;
            if ( is_array( $maybe_options ) ) {
                $options = $maybe_options;
            } else if ( function_exists( 'openwatch_optionsframework_options' ) ) {
                $options = openwatch_optionsframework_options();
            }
