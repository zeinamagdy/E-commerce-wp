...
if(!function_exists('of_recognized_background_repeat')) {
    ...
    {
        $default = array(
            'no-repeat' => __('No Repeat', 'openswatch'),
            'repeat-x' => __('Repeat Horizontally', 'openswatch'),
            'repeat-y' => __('Repeat Vertically', 'openswatch'),
            'repeat' => __('Repeat All', 'openswatch'),
        );
...
if(!function_exists('of_recognized_background_position')) {
    ...
    {
        $default = array(
            'top left' => __('Top Left', 'openswatch'),
            'top center' => __('Top Center', 'openswatch'),
            'top right' => __('Top Right', 'openswatch'),
            'center left' => __('Middle Left', 'openswatch'),
            'center center' => __('Middle Center', 'openswatch'),
            'center right' => __('Middle Right', 'openswatch'),
            'bottom left' => __('Bottom Left', 'openswatch'),
            'bottom center' => __('Bottom Center', 'openswatch'),
            'bottom right' => __('Bottom Right', 'openswatch')
        );
...
if(!function_exists('of_recognized_background_attachment')) {
    ...
    {
        $default = array(
            'scroll' => __('Scroll Normally', 'openswatch'),
            'fixed' => __('Fixed in Place', 'openswatch')
        );
...
if(!function_exists('of_recognized_font_styles')) {
    ...
    {
        $default = array(
            'normal' => __('Normal', 'openswatch'),
            'italic' => __('Italic', 'openswatch'),
            'bold' => __('Bold', 'openswatch'),
            'bold italic' => __('Bold Italic', 'openswatch')
        );
