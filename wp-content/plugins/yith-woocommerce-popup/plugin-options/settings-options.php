...
$settings = array(
    ...
    'settings' => array(
        ...
        'general' => array(
            ...
            array( 'name' => __( 'Show on all pages', 'yith-woocommerce-popup' ),
                   'desc' => __( 'Enable newsletter popup in all pages.', 'yith-woocommerce-popup' ),
                   'id'   => 'ypop_enabled_everywhere',
                   'type' => 'on-off',
                   'std'  => 'yes' ),

            array( 'name' => __( 'Select where you want to show the popup', 'yith-woocommerce-popup' ),
            ...
            array( 'name' => __( 'Cookie Variable', 'yith-woocommerce-popup' ),
            ...
            array( 'name' => __( 'Hide policy', 'yith-woocommerce-popup' ),
            ...
            array( 'name' => __( 'How many days should the popup be hidden for?', 'yith-woocommerce-popup' ),
            ...
            array( 'name' => __( 'Hiding text', 'yith-woocommerce-popup' ),
            ...
            array( 'name' => __( 'Select the default popup', 'yith-woocommerce-popup' ),
