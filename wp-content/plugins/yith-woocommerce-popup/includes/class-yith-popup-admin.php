...
if( ! class_exists( 'YITH_Popup_Admin' ) ) {
    ...
    class YITH_Popup_Admin {
        ...
        public function action_links( $links ) {
            ...
            $links[] = '<a href="' . admin_url( "admin.php?page={$this->_panel_page}" ) . '">' . __( 'Settings', 'yith-woocommerce-popup' ) . '</a>';
//            if ( defined( 'YITH_YPOP_FREE_INIT' ) ) {
//                $links[] = '<a href="' . $this->get_premium_landing_uri() . '" target="_blank">' . __( 'Premium Version', 'yith-woocommerce-popup' ) . '</a>';
//            }
        ...
        public function plugin_row_meta( $plugin_meta, $plugin_file, $plugin_data, $status ) {
            ...
            if ( defined( 'YITH_YPOP_INIT' ) && YITH_YPOP_INIT == $plugin_file ) {
                $plugin_meta[] = '<a href="' . $this->doc_url . '" target="_blank">' . __( 'Plugin Documentation', 'yith-woocommerce-popup' ) . '</a>';
            }
            return $plugin_meta;
        }
        ...
        public function register_panel() {
            ...
            $args = array(
                ...
                'parent_slug'      => '',
                'page_title'       => __( 'WC Popup', 'yith-woocommerce-popup' ),
                'menu_title'       => __( 'WC Popup', 'yith-woocommerce-popup' ),
